...
void temp_selec_mode(void){
  ...
  Serial.print("Select Temperature: ");
  Serial.print(temp_selec_cal);
  Serial.println("°C");
  ...
  if(!button_selec_state){
    ...
    Serial.println("Starting Temperature Ramp Up...");
...
void ramp_mode(void){
  ...
  Serial.print(temp_selec_display);
  Serial.println("°C");
  ...
  if(!button_selec_state){
    ...
    Serial.println("Canceling Ramping...");
  ...
  if(temp_cal > (temp_selec_cal - 4)){
    ...
    Serial.println("Starting PID Mode...");
